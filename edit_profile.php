...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="profile.php" class="active" style="position: fixed; bottom: 0; background-color: white;">
                <button>
                    <span>
    ...
    if (isset($_POST['btnEditProfile'])) {
        ...
        if (mysqli_query($conn, $update_info)) {
            ...
            Swal.fire({
                title: 'Success',
                text: 'Updated the profile successfully',
                icon: 'success'
            }).then(() => {
                ...
                if ($old_pass == $row['Student_password']) {
                    if ($new_pass == $confirm_pass) {
                        ...
                        if (mysqli_query($conn, $update_login)) {
                            ...
                            Swal.fire({
                                title: 'Success',
                                text: 'Updated the Login credential successfully',
                                icon: 'success'
                            });
                          </script>";
                        }
        ...
        <div class="editpro">
            ...
            <form action="" method="post">
                ...
                <select id="course" name="new_course" required>
                    <option value="BS Information Technology" <?php if (isset($course) && $course == "BS Information Technology") {
                        echo "selected";
                    } ?>>BS Information Technology</option>
                    <option value="BS Civil Engineering" <?php if (isset($course) && $course == "BS Civil Engineering") {
                        echo "selected";
                    } ?>>BS Civil Engineering</option>
                    <option value="BS Mechanical Engineering" <?php if (isset($course) && $course == "BS Mechanical Engineering") {
                        echo "selected";
                    } ?>>BS Mechanical Engineering</option>
                    <option value="BS Electrical Engineering" <?php if (isset($course) && $course == "BS Electrical Engineering") {
                        echo "selected";
                    } ?>>BS Electrical Engineering</option>
                    <option value="BS Computer Engineering" <?php if (isset($course) && $course == "BS Computer Engineering") {
                        echo "selected";
                    } ?>>BS Computer Engineering</option>
                    <option value="BS Mathematics" <?php if (isset($course) && $course == "BS Mathematics") {
                        echo "selected";
                    } ?>>BS Mathematics</option>
                    <option value="BS Architecture" <?php if (isset($course) && $course == "BS Architecture") {
                        echo "selected";
                    } ?>>BS Architecture</option>
                    <option value="AB English Language" <?php if (isset($course) && $course == "AB English Language") {
                        echo "selected";
                    } ?>>AB English Language</option>
                    <option value="Bachelor of Secondary Education" <?php if (isset($course) && $course == "Bachelor of Secondary Education") {
                        echo "selected";
                    } ?>>Bachelor of Secondary Education</option>
                    <option value="Bachelor of Early Childhood Education" <?php if (isset($course) && $course == "Bachelor of Early Childhood Education") {
                        echo "selected";
                ...
                <select name="new_yearlevel" id="yearlevel">
                    <option value="1st Year" <?php if (isset($year) && $year == "1st Year") {
                        echo "selected";
                    } ?>>1st Year
                    </option>
                    <option value="2nd Year" <?php if (isset($year) && $year == "2nd Year") {
                        echo "selected";
                    } ?>>2nd Year
                    </option>
                    <option value="3rd Year" <?php if (isset($year) && $year == "3rd Year") {
                        echo "selected";
                    } ?>>3rd Year
                    </option>
                    <option value="4th Year" <?php if (isset($year) && $year == "4th Year") {
                        echo "selected";
                    } ?>>4th Year
                    </option>
                    <option value="5th Year" <?php if (isset($year) && $year == "5th Year") {
                        echo "selected";
                    } ?>>5th Year
                    </option>
                </select>
                ...
                <select name="new_block" id="block">
                    <option value="A" <?php if (isset($block) && $block == "A") {
                        echo "selected";
                    } ?>>A</option>
                    <option value="B" <?php if (isset($block) && $block == "B") {
                        echo "selected";
                    } ?>>B</option>
                    <option value="C" <?php if (isset($block) && $block == "C") {
                        echo "selected";
                    } ?>>C</option>
                    <option value="D" <?php if (isset($block) && $block == "D") {
                        echo "selected";
                    } ?>>D</option>
                    <option value="E" <?php if (isset($block) && $block == "E") {
                        echo "selected";
                    } ?>>E</option>
                </select>
                <br><br>
