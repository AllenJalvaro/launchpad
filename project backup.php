 ...
 ?>
                                            ...
                                            justify-content: center;
                                                align-items: center;">
                                                                                                ...
                                                                                                <p class="projectOverviewDirection">Congratulations to the exceptional team behind <b><?php echo $project_name; ?>!</b> Your dedication and hard work have brought your startup project to an impressive stage. We're thrilled to announce that you now have the choice to make your project public, opening the doors to potential investors. This is a significant milestone, and we're excited to see your innovative venture attract the attention it deserves. Best of luck as you take this next exciting step! 🚀✨</p><br>
                                                                                           

                                                                                            
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                                                            <button class="btnPublic" name="btnPublic"
