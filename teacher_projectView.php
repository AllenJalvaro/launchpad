                        ...
                        <br>
                                                                ...
                                                                <!-- <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                                                                    <button class="saveBtn" name="btnSave"
                                                                        ...
                                                                        title="This will save your project. Easily return to your work later without losing progress.">Ready for Evaluation</button>
                                                                </div> -->
...
timer: 3000, 
    ...
    window.location.href = 'teacher_projectView.php?project_id=" . $_SESSION['projecid'] . "';
});
</script>";
...
timer: 3000, 
                                       ...
                                       <div class="overview-comment-section-container">
                                           ...
                                           <textarea name="mentor_comment_videopitch" id="mentor_comment_videopitch"  rows="5" placeholder="Write your feedback here..."></textarea>
                                           </div>
                                   
                                           <div class="floating-icon-overview"><button  type="submit"  style="border: none; background: none; color: black; text-decoration: none;" name="btnCommentVideoPitch"><i class="fas fa-paper-plane" style="color: #006BB9"></i></button>
                                           </div>
                                       </div>
                                   </form>
                    ...
                    <?php
                                                                     ...
                                                                     ?>
                                                                                                            ...
                                                                                                            <div class="phaseSection" style="width: 100%;">
                                                                                                              ...
                                                                                                              <div class="pdf-preview2" style="width: 100%; height: 200px;">
                                                                                                            Startup Model Canvas not uploaded yet..
                                                                                                            </div>
                                                                                                            <br><br>
